...
import com.jsrdev.horoscope.ui.detail.HoroscopeDetailActivity
...
class MainActivityTest {
    ...
    fun when_mainActivity_is_created_then_open_luck_fragment() {
        onView(withId(R.id.luckFragment))
            .perform(click())
    }

    // para ejecutar el test, desactivar las animaciones desde perfil de desarrollador del movil
    @Test
